...
from nets.refine_net_bn import RefineNet, ResNetBase, DilatedPyramidPooling
...
class Model:
    def __init__(self, name, split):
        ...
        self.net = RefineNet(ResNetBase(resnet.resnet50(pretrained=True)), crp=DilatedPyramidPooling)
        self.tta = [
