...
from nets.refinenet_hypercolumn import ExtremeHypercolumnRefineNet, RefineNetUpsampleClassifier
...
class Model:
    def __init__(self, name, split):
        ...
        self.net = ExtremeHypercolumnRefineNet(
            DPN92Base(dpn92()),
            num_features=128,
            block_multiplier=1,
            num_features_base=[256 + 80, 512 + 192, 1024 + 528, 2048 + 640],
            classifier=lambda channels: RefineNetUpsampleClassifier(channels, scale_factor=1)
        )
        self.tta = [
