...
from nets.refinenet import ModifiedRefineNetUpsampleClassifier, SCSERefineNetBlock
...
class Model:
    def __init__(self, name, split):
        ...
        self.net = HypercolumnCatRefineNet(
            ...
            num_features=128,
            block_multiplier=1,
            classifier=lambda c: ModifiedRefineNetUpsampleClassifier(640, channels=128, scale_factor=2),
