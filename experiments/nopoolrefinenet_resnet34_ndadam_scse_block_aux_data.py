...
samples_aux = utils.get_aux_samples()
...
class Model:
    ...
    def train(self, net, samples, optimizer, e):
        ...
        transforms_aux = generator.TransformationsGenerator([
            random.RandomFlipLr(),
            random.RandomAffine(
                image_size=101,
        ...
        dataset_aux = datasets.ImageDataset(samples_aux, './data/auxiliary_small', transforms_aux)
