...
from nets.lkm import LargeKernelMattersNet, NoUpsampleClassifier, SCSEGCN
...
class Model:
    def __init__(self, name, split):
        ...
        self.net = LargeKernelMattersNet(
            ...
            classifier=NoUpsampleClassifier(128, 128),
            gcn=SCSEGCN
        )
        self.tta = [
    ...
    def fit(self, samples_train, samples_val):
        ...
        optimizer = NDAdam(net.parameters(), lr=4e-4, weight_decay=1e-4)
