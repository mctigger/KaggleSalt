...
from nets.refinenet import RefineNet, RefineNetDropoutUpsampleClassifier, MrF
...
class Model:
    def __init__(self, name, split):
        ...
        self.net = RefineNet(
            ...
            classifier=lambda c: RefineNetDropoutUpsampleClassifier(c, scale_factor=2, dropout=0.1, align_corners=True),
            mrf=lambda channels, scale_factors: MrF(channels, scale_factors, align_corners=True)
        )
        self.tta = [
