...
from nets.refine_net_bn import RefineNet, ResNetBase, BottleneckRCU
...
class Model:
    def __init__(self, name, split):
        ...
        self.net = RefineNet(ResNetBase(resnet.resnet50(pretrained=True)), num_features=128, rcu=BottleneckRCU)
        self.tta = [
