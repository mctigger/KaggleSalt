...
class Model:
    ...
    def train(self, samples_train, samples_val):
        ...
        lr_scheduler = utils.CyclicLR(optimizer, 1e-7, 1e-4, 5)
        ...
        transforms_train = generator.TransformationsGenerator([
            ...
            random.RandomAffine(
                image_size=101,
                translation=lambda rs: (0, rs.randint(-20, 20)),
                scale=lambda rs: (1, rs.uniform(0.8, 1.2)),
                shear=lambda rs: rs.randint(-10, 10),
