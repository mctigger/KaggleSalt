...
class Model:
    def __init__(self, name, split):
        ...
        self.net = RefineNet(resnet.resnet50(pretrained=True))
    ...
    def train(self, samples_train, samples_val):
        ...
        pseudo_dataset = datasets.SemiSupervisedImageDataset(test_samples, './data/test', transforms_train, size=len(train_dataset) * 1//5)
