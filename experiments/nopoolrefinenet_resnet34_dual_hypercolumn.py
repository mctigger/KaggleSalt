...
from nets.refinenet import SmallDropoutRefineNetUpsampleClassifier, OC, SCSERefineNetBlock, CRP
...
class Model:
    def __init__(self, name, split):
        ...
        self.net = DualHypercolumnCatRefineNet(
            ...
            num_features=256,
            block_multiplier=1,
            classifier=lambda c: SmallDropoutRefineNetUpsampleClassifier(512, scale_factor=2),
            crp=[OC, OC, OC, OC],
