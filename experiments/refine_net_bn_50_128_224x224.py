...
from nets.refine_net_bn import RefineNet, ResNetBase, RefineNetUpsampleClassifier
...
resize = transformations.Resize((224, 224), **utils.transformations_options)
...
class Model:
    def __init__(self, name, split):
        ...
        self.net = RefineNet(ResNetBase(
            ...
            num_features=128,
            classifier=lambda channels: RefineNetUpsampleClassifier(channels, 2)
        )
        self.tta = [
