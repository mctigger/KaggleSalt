...
class Model:
    ...
    def train(self, samples_train, samples_val):
        ...
        transforms_train = generator.TransformationsGenerator([
            ...
            random.RandomAffine(
                image_size=101,
                translation=lambda rs: (rs.randint(-20, 20), rs.randint(-10, 10)),
                scale=lambda rs: (rs.uniform(0.85, 1.15), rs.uniform(0.95, 1.05)),
...
if __name__ == "__main__":
    ...
    for i, (samples_train, samples_val) in enumerate(utils.mask_stratified_k_fold()):
        ...
        val_predictions.add_predictions(samples_val)
