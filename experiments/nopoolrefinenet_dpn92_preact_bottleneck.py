...
from nets.refinenet import RefineNet, RefineNetUpsampleClassifier, PreActivationBottleneckRCU, PreActivationRCU
...
class Model:
    def __init__(self, name, split):
        ...
        self.net = RefineNet(
            ...
            classifier=lambda c: RefineNetUpsampleClassifier(4*c, scale_factor=2, rcu=PreActivationRCU, channels=64),
            rcu=PreActivationBottleneckRCU
        )
        self.tta = [
