...
class Model:
    ...
    def fit(self, samples_train, samples_val):
        ...
        optimizer = SGD(net.parameters(), lr=1e-3, weight_decay=1e-4, momentum=0.9, nesterov=True)
        lr_scheduler = ReduceLROnPlateau(optimizer, 'max', verbose=True)
        ...
        for e in range(epochs):
            ...
            lr_scheduler.step(stats_val['val_mAP'])
