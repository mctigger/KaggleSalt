...
class RandomPipeline(RandomTransformation):
    ...
    def draw(self, rs):
        ...
        for t in self.transforms:
            if isinstance(t, RandomTransformation):
...
class RandomLambda(RandomTransformation):
    def __init__(self, fn, transforms):
        self.fn = fn
        self.transforms = transforms

    def draw(self, rs):
        if isinstance(self.transforms, RandomTransformation):
...
class RandomBinary(RandomTransformation):
...
class RandomAffine(RandomTransformation):
    """
...
class RandomCrop(RandomTransformation):
...
class RandomResizedCrop(RandomTransformation):
    """
    ...
    def draw(self, rs):
        for attempt in range(10):
            ...
            if w <= 1 and h <= 1:
                ...
                transform = transformations.Pipeline([
...
class RandomColorAdjustment(RandomTransformation):
    """
...
class RandomColorPerturbation(RandomTransformation):
    """
...
class RandomDistortion(RandomTransformation):
    """
...
class RandomPadding(RandomTransformation):
